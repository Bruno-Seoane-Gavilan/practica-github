...
while not(numero==-99):
    if numero!=-99:
        ...
        if numero%2==0:
            ...
            total_suma_numeros=total_suma_numeros+numero 
print("RESUMEN")   
print("El números de pares es: ",total_pares)
print("El total de números impares es: ",total_impares)
print("El total de números positivos es: ",total_positivos)
print("El total de números negativos es: ",total_negativos)
print("El total de ceros es: ",total_ceros)
print("El total de la suma de todos los números introducidos es: ",total_suma_numeros)